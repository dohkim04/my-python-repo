...
#        if file_names == [] and sub_dir_names == []:
#            # do nothing. move on. This means there is no file and no directory.
#        if file_names != [] and sub_dir_names == []:
#            # loop through file_names
#        if file_names == [] and sub_dir_names != []:
#            # loop through sub_dir_names 
#        if file_names != [] and sub_dir_names != []:
#            # loop through sub_dir_names first, then loop through file_names under each sub-directory, 

#        if len(file_names) >=1 and len(sub_dir_names) >=1:
#            get_file_list(root, file_names)
#            for each_sub_dir in sub_dir_names:
#                get_tree_directory(os.path.join(root, each_sub_dir))
#        elif len(file_names) >=1 and len(sub_dir_names) == 0:
#            get_file_list(root, file_names)
#        elif len(file_names) == 0 and len(sub_dir_names) >=1: 
#            for each_sub_dir in sub_dir_names:
#                get_tree_directory(os.path.join(root, each_sub_dir))
#        else:
#            pass    
...
#        if file_names!=[]:
#            get_file_list(root, file_names)
#        if file_names==[] and sub_dir_names == []: # In case there are no sub-directories under your current directory,                                
...
#                get_tree_directory(os.path.join(root, each_sub_dir)) # create a list of the path and the size of all the files under each sub-directory.  
...
{'path': '/home/dohyungkim2023/my-python-repo/.git/logs/refs/heads/dkim-04102023', 'size': 345}
...
{'path': '/home/dohyungkim2023/my-python-repo/week13/wk13-project_walk_fd_v3_rev1.py', 'size': 83441}
