...
#####################################################################
def get_file_list(root, file_names):
    print(f'##### This is the directory of "{os.path.join(root)}"')
...
~/my-python-repo$ ./week13/wk13-project_walk_fd_v3_rev1.py
...
{'path': '/home/dohyungkim2023/my-python-repo/.git/index', 'size': 2392}
...
{'path': '/home/dohyungkim2023/my-python-repo/week13/wk13-project_walk_fd_v3_rev1.py', 'size': 57749}
{'path': '/home/dohyungkim2023/my-python-repo/week13/wk13-project_walk_fd_v4.py', 'size': 6191}
...
See the final version of a lits of dictionary below:
 ...
 [{'path': '/tmp/vscode-ipc-9f8c3cdc-d6cd-4600-ac88-ef181b78e5f0.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-a579b238-aee6-441e-9a3e-50f4600280dc.sock', 'size': 0}, {'path': '/tmp/vscode-git-e3178630d8.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-eeeb1938-f98d-4aac-b4e2-891fc8f79aad.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-c82d9ff2-eef1-43eb-9184-c0d6dff0edb3.sock', 'size': 0}, {'path': '/tmp/vscode-git-2be1a6dafc.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-d3c11888-d563-49c3-a56b-16b2bfdd5849.sock', 'size': 0}, {'path': '/tmp/vscode-git-5e6a80e9ee.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-141d4c98-6954-4321-910f-fcf0bbdccb81.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-1f22977b-e12a-4a62-a67c-01e9c899cb1e.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-78969be7-cdee-41cc-9003-639f57aab9bc.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-0bb1e8b3-ef33-42c0-8f22-ff61dad4a40e.sock', 'size': 0}, {'path': '/tmp/vscode-git-b28873833b.sock', 'size': 0}, {'path': '/tmp/tmp.hEla4nkhqj', 'size': 0}, {'path': '/tmp/vscode-ipc-71050d49-e4e7-40fc-bda0-dd1e8fceb35d.sock', 'size': 0}, {'path': '/tmp/vscode-git-988ff82b16.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-432b1b90-2533-4766-9541-8f0f3d4703fb.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-02e0e671-46c9-4f3f-a6fc-7fd507b9f501.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-44452adb-ca35-4615-a33f-f40ac0a3b648.sock', 'size': 0}, {'path': '/tmp/remote-wsl-loc.txt', 'size': 0}, {'path': '/tmp/vscode-ipc-bca815a7-723e-4785-b5f3-5c4beb1b7279.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-42f91b1c-eef8-40fe-87fe-945b854dc6fc.sock', 'size': 0}, {'path': '/tmp/vscode-git-4bb837c976.sock', 'size': 0}, {'path': '/tmp/vscode-git-81378a0f87.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-386d9fde-eb59-46a0-8219-ee6a44239aea.sock', 'size': 0}, {'path': '/tmp/vscode-git-36c52331eb.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-a30125be-8e3c-40fa-8373-6c6ed422a35b.sock', 'size': 0}, {'path': '/tmp/vscode-ipc-ade376b2-5d21-422e-be21-679876000211.sock', 'size': 0}, {'path': '/tmp/pyright-1362-5xZO3A5BGcOP/posix-1362-VCiYNkQujSH1-.py', 'size': 59005}, {'path': '/tmp/pyright-1362-5xZO3A5BGcOP/posixpath-1362-L1CY2htvnETe-.py', 'size': 4752}, {'path': '/tmp/pyright-1362-5xZO3A5BGcOP/builtins-1362-YN0Dk4QtuQJg-.py', 'size': 221402}]



[Case 3] Execute with 2 arguments 
$ ./week13/wk13-project_walk_fd_v3_rev1.py /tmp/ /lib/
Please use only 1 complete directory pathway as an argument
Try again.


[Case 4] Execute with non-existing directory
$ ./week13/wk13-project_walk_fd_v3_rev1.py sdg
No result found due to an invalid directory pathway. Try again.


[Case 5] Execute with a keyword for a valid system directory with no files or sub directories
## Note: it is a homework to improve the behavior of reporting a list of files more accurately.
$ ./week13/wk13-project_walk_fd_v3_rev1.py /sys/kernel/tracing/
##### This is the directory of "/sys/kernel/tracing/"
No result found due to an invalid directory pathway. Try again.
