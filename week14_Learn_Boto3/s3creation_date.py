# Display the creation time per each S3 bucket
import boto3
s3_resource=boto3.client('s3')
print(s3_resource.list_buckets())          # Output: {'ResponseMetadata': {'RequestId': '19SM6FBEPN6PPVW4', 'HostId': 'fFhqcFUvPXIyMxfLuxLmRV/SmOpqhsTZsg5EQiPjKsGlqGX7ElnZcLyTMknnQQ7Oy/XdjR/6KHg=', 'HTTPStatusCode': 200, 'HTTPHeaders': {'x-amz-id-2': 'fFhqcFUvPXIyMxfLuxLmRV/SmOpqhsTZsg5EQiPjKsGlqGX7ElnZcLyTMknnQQ7Oy/XdjR/6KHg=', 'x-amz-request-id': '19SM6FBEPN6PPVW4', 'date': 'Sat, 15 Apr 2023 12:50:45 GMT', 'content-type': 'application/xml', 'transfer-encoding': 'chunked', 'server': 'AmazonS3'}, 'RetryAttempts': 0}, 'Buckets': [{'Name': 'luit-gold-do-testmb', 'CreationDate': datetime.datetime(2023, 2, 10, 0, 59, 22, tzinfo=tzlocal())}, {'Name': 'mybucket04142023-v1', 'CreationDate': datetime.datetime(2023, 4, 15, 3, 0, 17, tzinfo=tzlocal())}, {'Name': 'mybucket04142023-v2', 'CreationDate': datetime.datetime(2023, 4, 15, 3, 13, 37, tzinfo=tzlocal())}], 'Owner': {'DisplayName': 'doh.kim17', 'ID': '309b7daf8c23db95b80dfd3fe475e0e810eb7716cb2c9e9bb726cf827dc6b5a0'}}
print(len(s3_resource.list_buckets()))     # list_buckets() retrieve a list of S3 buckets. len() determines the size of the list # Output: 3
print((s3_resource.list_buckets()).keys()) # Output: dict_keys(['ResponseMetadata', 'Buckets', 'Owner']) # Three keys 
print(s3_resource.list_buckets()['Buckets'])    # print the value corresponding to key of 'Buckets' from the dictionary. # Output: [{'Name': 'luit-gold-do-testmb', 'CreationDate': datetime.datetime(2023, 2, 10, 0, 59, 22, tzinfo=tzlocal())}, {'Name': 'mybucket04142023-v1', 'CreationDate': datetime.datetime(2023, 4, 15, 3, 0, 17, tzinfo=tzlocal())}, {'Name': 'mybucket04142023-v2', 'CreationDate': datetime.datetime(2023, 4, 15, 3, 13, 37, tzinfo=tzlocal())}]
print(s3_resource.list_buckets()['Buckets'][0]) #The first bucket element stored at index 0 of the above list. # Output: {'Name': 'luit-gold-do-testmb', 'CreationDate': datetime.datetime(2023, 2, 10, 0, 59, 22, tzinfo=tzlocal())}

first_bucket_create = s3_resource.list_buckets()['Buckets'][0]['CreationDate'] 
print(first_bucket_create) # print the date and time # Output ==> 2023-02-10 00:59:22+00:00
...
# retrieve all buckets' creation time info using for loop.
